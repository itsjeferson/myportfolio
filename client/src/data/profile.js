/**
 * ⚠️ EDIT ME — this is the single place to update your personal/profile info.
 * Replace every REPLACE_ME value with your real details.
 */
export const profile = {
  ...
  bio: [
    ...
    "I'm most energized by projects where I own a feature from database schema to shipped UI.",
  ],
  socials: {
